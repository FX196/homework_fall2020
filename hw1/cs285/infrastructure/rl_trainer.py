...
class RL_Trainer(object):
    ...
    def collect_training_trajectories(
        ...
        if itr == 0:
            return pickle.loads(load_initial_expertdata), 0, None
        ...
        paths, envsteps_this_batch = utils.sample_trajectories(self.env, self.agent, self.params['batch_size'], self.params['ep_len'])
    ...
    def train_agent(self):
        ...
        for train_step in range(self.params['num_agent_train_steps_per_iter']):
            ...
            train_log = self.agent.update(ob_batch, ac_batch)
