...
class PGAgent(BaseAgent):
    ...
    def _discounted_cumsum(self, rewards):
        ...
        list_of_discounted_cumsums = np.zeros(reward_length)
        list_of_discounted_cumsums[-1] = rewards[-1]
        index = reward_length - 2
        while index >= 0:
            list_of_discounted_cumsums[index] = rewards[index] + self.gamma * list_of_discounted_cumsums[index + 1]
            index -= 1
